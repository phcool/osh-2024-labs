...
const char * const x86_cap_flags[NCAPINTS*32] = {
	...
	[X86_FEATURE_AMD_LBR_V2]	 = "amd_lbr_v2",
	...
	[X86_FEATURE_TDX_HOST_PLATFORM]	 = "tdx_host_platform",
	...
	[X86_FEATURE_MBA]		 = "mba",
	[X86_FEATURE_PERFMON_V2]	 = "perfmon_v2",
	...
	[X86_FEATURE_TDX_GUEST]		 = "tdx_guest",
	...
	[X86_FEATURE_SPLIT_LOCK_DETECT]	 = "split_lock_detect",
	[X86_FEATURE_USER_SHSTK]	 = "user_shstk",
	[X86_FEATURE_AVX_VNNI]		 = "avx_vnni",
	[X86_FEATURE_AVX512_BF16]	 = "avx512_bf16",
	[X86_FEATURE_LAM]		 = "lam",
	[X86_FEATURE_CLZERO]		 = "clzero",
	[X86_FEATURE_IRPERF]		 = "irperf",
	[X86_FEATURE_XSAVEERPTR]	 = "xsaveerptr",
	[X86_FEATURE_RDPRU]		 = "rdpru",
	[X86_FEATURE_WBNOINVD]		 = "wbnoinvd",
	[X86_FEATURE_AMD_PPIN]		 = "amd_ppin",
	[X86_FEATURE_VIRT_SSBD]		 = "virt_ssbd",
	[X86_FEATURE_CPPC]		 = "cppc",
	[X86_FEATURE_BRS]		 = "brs",
	...
	[X86_FEATURE_BUS_LOCK_DETECT]	 = "bus_lock_detect",
	[X86_FEATURE_CLDEMOTE]		 = "cldemote",
	[X86_FEATURE_MOVDIRI]		 = "movdiri",
	[X86_FEATURE_MOVDIR64B]		 = "movdir64b",
	[X86_FEATURE_ENQCMD]		 = "enqcmd",
	[X86_FEATURE_SGX_LC]		 = "sgx_lc",
	...
	[X86_FEATURE_FSRM]		 = "fsrm",
	[X86_FEATURE_AVX512_VP2INTERSECT] = "avx512_vp2intersect",
	[X86_FEATURE_MD_CLEAR]		 = "md_clear",
	[X86_FEATURE_SERIALIZE]		 = "serialize",
	[X86_FEATURE_TSXLDTRK]		 = "tsxldtrk",
	[X86_FEATURE_PCONFIG]		 = "pconfig",
	[X86_FEATURE_ARCH_LBR]		 = "arch_lbr",
	[X86_FEATURE_IBT]		 = "ibt",
	[X86_FEATURE_AMX_BF16]		 = "amx_bf16",
	[X86_FEATURE_AVX512_FP16]	 = "avx512_fp16",
	[X86_FEATURE_AMX_TILE]		 = "amx_tile",
	[X86_FEATURE_AMX_INT8]		 = "amx_int8",
	[X86_FEATURE_FLUSH_L1D]		 = "flush_l1d",
	[X86_FEATURE_ARCH_CAPABILITIES]	 = "arch_capabilities",
	[X86_FEATURE_SME]		 = "sme",
	[X86_FEATURE_SEV]		 = "sev",
	[X86_FEATURE_SEV_ES]		 = "sev_es",
	[X86_FEATURE_DEBUG_SWAP]	 = "debug_swap",
};
...
const char * const x86_bug_flags[NBUGINTS*32] = {
	...
	[X86_BUG_MMIO_STALE_DATA - NCAPINTS*32]	 = "mmio_stale_data",
	[X86_BUG_MMIO_UNKNOWN - NCAPINTS*32]	 = "mmio_unknown",
	[X86_BUG_RETBLEED - NCAPINTS*32]	 = "retbleed",
	[X86_BUG_EIBRS_PBRSB - NCAPINTS*32]	 = "eibrs_pbrsb",
	[X86_BUG_SMT_RSB - NCAPINTS*32]		 = "smt_rsb",
	[X86_BUG_GDS - NCAPINTS*32]		 = "gds",
	[X86_BUG_TDX_PW_MCE - NCAPINTS*32]	 = "tdx_pw_mce",
	[X86_BUG_SRSO - NCAPINTS*32]		 = "srso",
	[X86_BUG_DIV0 - NCAPINTS*32]		 = "div0",
	[X86_BUG_RFDS - NCAPINTS*32]		 = "rfds",
};
...
const char * const x86_vmx_flags[NVMXINTS*32] = {
	...
	[VMX_FEATURE_EPT_1GB]		 = "ept_1gb",
	[VMX_FEATURE_FLEXPRIORITY]	 = "flexpriority",
	[VMX_FEATURE_APICV]		 = "apicv",
	[VMX_FEATURE_EPTP_SWITCHING]	 = "eptp_switching",
	[VMX_FEATURE_USE_TSC_OFFSETTING] = "tsc_offset",
	[VMX_FEATURE_VIRTUAL_TPR]	 = "vtpr",
	[VMX_FEATURE_MONITOR_TRAP_FLAG]	 = "mtf",
	[VMX_FEATURE_VIRT_APIC_ACCESSES] = "vapic",
	[VMX_FEATURE_EPT]		 = "ept",
	[VMX_FEATURE_VPID]		 = "vpid",
	[VMX_FEATURE_UNRESTRICTED_GUEST] = "unrestricted_guest",
	[VMX_FEATURE_APIC_REGISTER_VIRT] = "vapic_reg",
	[VMX_FEATURE_VIRT_INTR_DELIVERY] = "vid",
	[VMX_FEATURE_PAUSE_LOOP_EXITING] = "ple",
	[VMX_FEATURE_SHADOW_VMCS]	 = "shadow_vmcs",
	[VMX_FEATURE_PAGE_MOD_LOGGING]	 = "pml",
	[VMX_FEATURE_MODE_BASED_EPT_EXEC] = "ept_mode_based_exec",
	[VMX_FEATURE_TSC_SCALING]	 = "tsc_scaling",
	[VMX_FEATURE_USR_WAIT_PAUSE]	 = "usr_wait_pause",
	[VMX_FEATURE_NOTIFY_VM_EXITING]	 = "notify_vm_exiting",
