static const char x86_cap_strs[] =
	...
	"\x03\x10""rep_good\0"
#endif
#if REQUIRED_MASK3 & (1 << 17)
	"\x03\x11""amd_lbr_v2\0"
#endif
...
#endif
#if REQUIRED_MASK11 & (1 << 23)
	"\x0b\x17""user_shstk\0"
#endif
...
#endif
#if REQUIRED_MASK13 & (1 << 4)
	"\x0d\x04""rdpru\0"
#endif
#if REQUIRED_MASK13 & (1 << 9)
	"\x0d\x09""wbnoinvd\0"
#endif
#if REQUIRED_MASK13 & (1 << 23)
	"\x0d\x17""amd_ppin\0"
#endif
#if REQUIRED_MASK13 & (1 << 25)
	"\x0d\x19""virt_ssbd\0"
#endif
#if REQUIRED_MASK13 & (1 << 27)
	"\x0d\x1b""cppc\0"
#endif
#if REQUIRED_MASK13 & (1 << 31)
	"\x0d\x1f""brs\0"
#endif
	...
	"\x0f\x10""vgif\0"
#endif
#if REQUIRED_MASK15 & (1 << 18)
	"\x0f\x12""x2avic\0"
#endif
#if REQUIRED_MASK15 & (1 << 20)
	"\x0f\x14""v_spec_ctrl\0"
#endif
#if REQUIRED_MASK15 & (1 << 25)
	"\x0f\x19""vnmi\0"
#endif
	...
	"\x10\x16""rdpid\0"
#endif
#if REQUIRED_MASK16 & (1 << 24)
	"\x10\x18""bus_lock_detect\0"
#endif
	...
	"\x10\x1c""movdir64b\0"
#endif
#if REQUIRED_MASK16 & (1 << 29)
	"\x10\x1d""enqcmd\0"
#endif
#if REQUIRED_MASK16 & (1 << 30)
	"\x10\x1e""sgx_lc\0"
#endif
...
#endif
#if REQUIRED_MASK18 & (1 << 4)
	"\x12\x04""fsrm\0"
#endif
#if REQUIRED_MASK18 & (1 << 8)
	"\x12\x08""avx512_vp2intersect\0"
#endif
#if REQUIRED_MASK18 & (1 << 10)
	"\x12\x0a""md_clear\0"
#endif
#if REQUIRED_MASK18 & (1 << 14)
	"\x12\x0e""serialize\0"
#endif
#if REQUIRED_MASK18 & (1 << 16)
	"\x12\x10""tsxldtrk\0"
#endif
#if REQUIRED_MASK18 & (1 << 18)
	"\x12\x12""pconfig\0"
#endif
#if REQUIRED_MASK18 & (1 << 19)
	"\x12\x13""arch_lbr\0"
#endif
#if REQUIRED_MASK18 & (1 << 20)
	"\x12\x14""ibt\0"
#endif
#if REQUIRED_MASK18 & (1 << 22)
	"\x12\x16""amx_bf16\0"
#endif
#if REQUIRED_MASK18 & (1 << 23)
	"\x12\x17""avx512_fp16\0"
#endif
#if REQUIRED_MASK18 & (1 << 24)
	"\x12\x18""amx_tile\0"
#endif
#if REQUIRED_MASK18 & (1 << 25)
	"\x12\x19""amx_int8\0"
#endif
	...
	"\x13\x03""sev_es\0"
#endif
#if REQUIRED_MASK19 & (1 << 14)
	"\x13\x0e""debug_swap\0"
#endif
	"\x14\x1f"""
	;
